...
const BusinessLoginForm = () => {
    ...
    async function sendData(buttonType) {
        ...
        try {
            ...
            const APIEndPoint = buttonType === 'signUp' ? `${backendUrl}/api/user-unAuth/add-business` : `${backendUrl}/api/user-unAuth/business-login`;
            // Ternary operator to switch between the different webpages depending on the button pressed
            const UIEndPoint = buttonType !== 'signUp' ? `${frontendUrl}/businessDashboard` : `${frontendUrl}/businessAccountManagement`;
        ...
        <section className="flex h-screen">
            ...
            <div className="flex justify-center items-center w-1/2">
                ...
                <div className="text-center p-6 w-96 border-2 border-gray-700 text-lg rounded-3xl shadow-2xl">
                    <h1 className="py-4 text-xl font-semibold text-gray-700">Business Account Management</h1>
